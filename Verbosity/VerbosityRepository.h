...
/*schema is as follows
 ...
 CREATE TABLE GameStats(id INTEGER PRIMARY KEY AUTOINCREMENT, datePlayed INTEGER NOT NULL, RareWordsFound integer, Score integer NOT NULL, RelatedLanguageID INTEGER NOT NULL, WordsPerMinute INTEGER NOT NULL, AttemptedWords INTEGER NOT NULL, LongestStreak INTEGER NOT NULL,  LongestColdStreak INTEGER NOT NULL, TotalWordsFound integer not null default 0, FOREIGN KEY(RelatedLanguageID) REFERENCES Languages(id));
