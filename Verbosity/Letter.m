...
NSString* currentLetterString = [[NSString stringWithFormat:@"%c", letter] uppercaseString]; // letter A-Z;
    ...
    CCLabelTTF *currentLetter = [CCLabelTTF labelWithString:currentLetterString dimensions:sprite.contentSize hAlignment:kCCTextAlignmentRight fontName:@"ArialRoundedMTBold" fontSize:20];
